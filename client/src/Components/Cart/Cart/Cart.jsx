...
function Cart() {
  const cart = useSelector((state) => state.todos.cart);
  const paymentLink = useSelector((state) => state.todos.paymentLink);
  const userUnique = useSelector((state) => state.todos.userInfo);
