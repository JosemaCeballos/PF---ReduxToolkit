...
function ProductDetail() {
  ...
  const produDetail = useSelector((state) => state.todos.productDetail);
  const failMsg = useSelector((state) => state.todos.searchProductMsg);
  const favoriteMsg = useSelector((state) => state.todos.favoriteMsg);
  const userInfo = useSelector((state) => state.todos.userInfo);
  const favs = useSelector((state) => state.todos.favorites);
