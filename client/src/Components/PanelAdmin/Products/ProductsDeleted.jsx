...
import { getProductDeleted } from '../../../redux/todo.slice';
...
function ProductsDeleted() {
  ...
  const productDeleted = useSelector((state) => state.todos.productsDeleted);
  const msgErrorDelet = useSelector((state) => state.todos.msgProductDeleted);
