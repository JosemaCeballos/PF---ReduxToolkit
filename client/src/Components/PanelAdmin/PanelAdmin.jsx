...
function PanelAdmin() {
  ...
  const products = useSelector((state) => state.todos.allProduct);
  const deleted = useSelector((state) => state.todos.productsDeleted);
  const users = useSelector((state) => state.todos.users);
  const orders = useSelector((state) => state.todos.allOrders);
