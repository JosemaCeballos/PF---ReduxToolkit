...
function Filters() {
  ...
  let { categoryDetails } = useSelector((state) => state.todos);
  console.log(categoryDetails);
  let anyMoreCategory = useSelector((state) => state.todos.category);
  ...
  let dispatchCategory = (e) => {
    ...
    const getDetails = async () => {
      ...
      let categoryDetail = store.getState().todos.categoryDetails;
